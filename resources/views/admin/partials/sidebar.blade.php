                ...
                {{-- <li class="nav-item mt-3">
                    ...
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#layanan"
                            class="nav-link {{ Route::is('yyy.*') ? 'active' : '' }}" aria-controls="program"
                        ...
                        <div class="collapse id="layanan">
                            <ul class="nav ms-4 ps-3">
                                <li class="nav-item ">
                                    <a class="nav-link {{ Route::is('sewa-ruang','index') ? 'active' : '' }}"
                                        href="{{route('sewa-ruang.index')}}">
                                        <span class="sidenav-mini-icon"> K </span>
                                        <span class="sidenav-normal"> Sewa Studio </span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link {{ Route::is('sewa_perangkat', 'index') ? 'active' : '' }}"
                                        href="{{ route('sewa-perangkat.index') }}">
                                        <span class="sidenav-mini-icon"> K </span>
                                        <span class="sidenav-normal"> Sewa Perangkat </span>
                                    </a>
                                </li>
                            </ul>
                        </div>
