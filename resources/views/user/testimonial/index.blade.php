    ...
    <div class="container-fluid py-4">
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <p>Anda belum mengisi data testimonial, silahkan isi terlebih dahulu!</p>
          </div>
        ...
        <div class="row">
            ...
            {{-- <div class="col-lg-6 text-right d-flex flex-column justify-content-center">
              <a class="btn bg-gradient-primary mb-0 ms-lg-auto me-lg-0 me-auto mt-lg-0 mt-2" href="{{route('testimonial.edit', $profil->id)}}">Edit</a>
            </div> --}}
          </div>
        <div class="row mt-4">
          <div class="col-lg-4">
