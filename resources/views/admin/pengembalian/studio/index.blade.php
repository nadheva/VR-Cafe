                  ...
                  <tbody>
                    ...
                    <td>
                      ...
                      <td class="text-sm">
                        ...
                        <a class="btn btn-link text-dark px-3 mb-0" href="" data-bs-toggle="modal" data-bs-target="#editStudio-{{$i->id}}"><i class="fas fa-user-edit text-secondary"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
            ...
            <div class="modal-content">
                <form method="post" action="{{ url('sewa-ruang-update', $i->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="editStudioLabel">Verifikasi Pengembalian</h5>
